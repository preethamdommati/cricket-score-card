...
{
	printf("\n------------------------------------------------------------");
printf("\n%s: %d/%d\t  %s    %d*(%d)\t\t",team1,sum1,wicket1,player1[p1-1],play1[p1-1],ball1[p1-1],(float)sum1/ball*6);
...
{
printf("\n------------------------------------------------------------");
printf("\n%s: %d/%d\t  %s    %d*(%d)\t \t\t",team2,sum2,wicket2,player2[p1-1],play2[p1-1],ball2[p1-1],(float)sum2/ball*6);
